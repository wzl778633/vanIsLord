...
<div id = "errpageStage">
  ...
  <p class = "back" @click = "backToMainPage">点击我返回现实</p>
  <div class="error">
    <div class="wrap">
      <div class="404">
    <pre><code>
      ...
      <span class="orange">&lt;html&gt;</span>
        <span class="orange">&lt;style&gt;</span>
                * {
		        <span class="green">我</span>:<span class="blue">究竟是谁</span>;
            }
        <span class="orange">&lt;/style&gt;</span>
        <span class="orange">&lt;body&gt;</span>
            VANISLORD.EXE出现错误...
              ...
              ERROR 404!
				...
				<span class="comment">&lt;!--迷失在现实的泥潭中--&gt;</span>
  ...
  methods:{
    backToMainPage(){
      if(!localStorage.loginToken) {
        ...
        this.$router.replace("/mainpage/disk/"+this.$store.state.user_name);
      }
    }
  },
...
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url(../assets/fonts/t5tmIRoYMoaYG0WEOh7HwMeR3TDPr6OH.woff2) format('woff2');
...
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url(../assets/fonts/t5tmIRoYMoaYG0WEOh7HwMeR3T7Prw.woff2) format('woff2');
